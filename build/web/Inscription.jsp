  ...
  background-color: #06b;
    ...
    <body>
      ...
      <div class="input-container ic1">
        <input id="firstname" class="input" type="text" placeholder=" "  name="nom" value="" />
        <div class="cut"></div>
        <label for="firstname" class="placeholder">Nom</label>
      </div>
      <div class="input-container ic2">
        <input id="lastname" class="input" placeholder=" "type="text" name="prenom" value="" />
        <div class="cut"></div>
        <label for="lastname" class="placeholder">Prenom</label>
      </div>
      <div class="input-container ic2">
        <input id="email" class="input" placeholder=" "type="text" name="email" value="" />
        <div class="cut"></div>
